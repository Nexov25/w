...
const makeMessagesSocket = (config) => {
    ...
    let mediaConn;
    const refreshMediaConn = (forceGet = false) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const relayMessage = (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield authState.keys.transaction(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const stanza = {
                tag: 'message',
                attrs: Object.assign({ id: msgId, type: 'text' }, (additionalAttributes || {})),
    ...
    return Object.assign(Object.assign({}, sock), { getPrivacyTokens,
        ...
        fetchPrivacySettings, updateMediaMessage: (message) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return message;
        }), sendMessage: (jid, content, options = {}) => __awaiter(void 0, void 0, void 0, function* () {
            var _d, _e;
            ...
            if (typeof content === 'object' &&
                ...
                if (isDeleteMsg) {
                    ...
                    if ((0, WABinary_1.isJidGroup)((_d = content.delete) === null || _d === void 0 ? void 0 : _d.remoteJid) && !((_e = content.delete) === null || _e === void 0 ? void 0 : _e.fromMe)) {
                ...
                yield relayMessage(jid, fullMsg.message, { messageId: fullMsg.key.id, cachedGroupMetadata: options.cachedGroupMetadata, additionalAttributes, statusJidList: options.statusJidList });
