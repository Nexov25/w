...
const makeChatsSocket = (config) => {
    ...
    const fetchPrivacySettings = (force = false) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                for (const key in decoded) {
                    ...
                    try {
                        ...
                        const isIrrecoverableError = attemptsMap[name] >= MAX_SYNC_ATTEMPTS
                            || ((_h = error.output) === null || _h === void 0 ? void 0 : _h.statusCode) === 404
                            || error.name === 'TypeError';
                        logger.info({ name, error: error.stack }, `failed to sync state from version${isIrrecoverableError ? '' : ', removing and trying from scratch'}`);
                        yield authState.keys.set({ 'app-state-sync-version': { [name]: null } });
     ...
     */
    const profilePictureUrl = (jid, type = 'preview', timeoutMs) => __awaiter(void 0, void 0, void 0, function* () {
        var _j;
        ...
        return (_j = child === null || child === void 0 ? void 0 : child.attrs) === null || _j === void 0 ? void 0 : _j.url;
    });
    ...
    const fetchAbt = () => __awaiter(void 0, void 0, void 0, function* () {
        const abtNode = yield query({
            tag: 'iq',
            attrs: {
                to: WABinary_1.S_WHATSAPP_NET,
                xmlns: 'abt',
    ...
    */
    ...
    const upsertMessage = ev.createBufferedFunction((msg, type) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!!msg.pushName) {
            ...
            if (msg.key.fromMe && msg.pushName && ((_k = authState.creds.me) === null || _k === void 0 ? void 0 : _k.name) !== msg.pushName) {
        ...
        if (((_m = (_l = msg.message) === null || _l === void 0 ? void 0 : _l.protocolMessage) === null || _m === void 0 ? void 0 : _m.appStateSyncKeyShare)
            && pendingAppStateSync) {
            yield doAppStateSync();
            pendingAppStateSync = false;
        }
