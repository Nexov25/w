...
const makeSocket = (config) => {
     ...
     */
    const waitForMessage = (msgId, timeoutMs = defaultQueryTimeoutMs) => __awaiter(void 0, void 0, void 0, function* () {
        let onRecv;
        let onErr;
        try {
    ...
    const uploadPreKeys = (count = Defaults_1.INITIAL_PREKEY_COUNT) => __awaiter(void 0, void 0, void 0, function* () {
