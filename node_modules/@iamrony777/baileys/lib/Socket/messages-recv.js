...
const makeMessagesRecvSocket = (config) => {
    ...
    const sendMessageAck = ({ tag, attrs }) => __awaiter(void 0, void 0, void 0, function* () {
        const stanza = {
            tag: 'ack',
            attrs: {
                id: attrs.id,
    ...
    const sendRetryRequest = (node, forceIncludeKeys = false) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handleReceipt = (node) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const isNodeFromMe = (0, WABinary_1.areJidsSameUser)(attrs.participant || attrs.from, isLid ? (_b = authState.creds.me) === null || _b === void 0 ? void 0 : _b.lid : (_c = authState.creds.me) === null || _c === void 0 ? void 0 : _c.id);
        ...
        yield Promise.all([
            processingMutex.mutex(() => __awaiter(void 0, void 0, void 0, function* () {
                ...
                if (msg) {
                    ...
                    (_d = msg.participant) !== null && _d !== void 0 ? _d : (msg.participant = node.attrs.participant);
    ...
    const handleMessage = (node) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (((_f = (_e = msg.message) === null || _e === void 0 ? void 0 : _e.protocolMessage) === null || _f === void 0 ? void 0 : _f.type) === WAProto_1.proto.Message.ProtocolMessage.Type.SHARE_PHONE_NUMBER) {
    ...
    const handleBadAck = ({ attrs }) => __awaiter(void 0, void 0, void 0, function* () {
