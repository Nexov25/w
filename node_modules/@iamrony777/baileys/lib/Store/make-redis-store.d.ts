...
declare const _default: ({ logger: _logger, chatKey, labelAssociationKey, redis, suffix, }: BaileysInMemoryStoreConfig) => {
    ...
    getContactInfo: (chatId: string) => Promise<Contact | null>;
    /**
    ...
    uploadToDb: () => Promise<void>;
    readFromDb: () => Promise<void>;
};
