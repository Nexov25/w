...
const getCompressedJpegThumbnail = (url, { thumbnailWidth, fetchOpts }) => __awaiter(void 0, void 0, void 0, function* () {
...
const getUrlInfo = (text, opts = {
    ...
    try {
        ...
        const info = yield getLinkPreview(previewLink, Object.assign(Object.assign({}, opts.fetchOpts), { followRedirects: 'manual', handleRedirects: (baseURL, forwardedURL) => {
