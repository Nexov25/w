...
const printQRIfNecessaryListener = (ev, logger) => {
    ev.on('connection.update', ({ qr }) => __awaiter(void 0, void 0, void 0, function* () {
        if (qr) {
            const QR = yield import('qrcode-terminal')
                .then(m => m.default || m)
                .catch(() => {
 ...
 */
const fetchLatestBaileysVersion = (options = {}) => __awaiter(void 0, void 0, void 0, function* () {
