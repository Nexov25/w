...
const encodeSyncdPatch = ({ type, index, syncAction, apiVersion, operation }, myAppStateKeyId, state, getAppStateSyncKey) => __awaiter(void 0, void 0, void 0, function* () {
...
const decodeSyncdSnapshot = (name, snapshot, getAppStateSyncKey, minimumVersionNumber, validateMacs = true) => __awaiter(void 0, void 0, void 0, function* () {
...
const decodePatches = (name, syncds, initial, getAppStateSyncKey, options, minimumVersionNumber, logger, validateMacs = true) => __awaiter(void 0, void 0, void 0, function* () {
    var _e;
    ...
    for (let i = 0; i < syncds.length; i++) {
        ...
        if (syncd.externalMutations) {
            ...
            (_e = syncd.mutations) === null || _e === void 0 ? void 0 : _e.push(...ref.mutations);
        }
