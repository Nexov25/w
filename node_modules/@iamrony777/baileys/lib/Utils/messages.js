...
const prepareWAMessageMedia = (message, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { mediaKey, encWriteStream, bodyPath, fileEncSha256, fileSha256, fileLength, didSaveToTmpPath } = yield (0, messages_media_1.encryptedStream)(uploadData.media, options.mediaTypeOverride || mediaType, {
        logger,
    ...
    const obj = Types_1.WAProto.Message.fromObject({
        [`${mediaType}Message`]: MessageTypeProto[mediaType].fromObject(Object.assign(Object.assign({ url: mediaUrl, directPath,
            mediaKey,
            fileEncSha256,
            fileSha256,
            fileLength, mediaKeyTimestamp: (0, generics_1.unixTimestampSeconds)() }, uploadData), { media: undefined }))
    });
    if (cacheableKey) {
...
const generateWAMessageContent = (message, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ('text' in message) {
        ...
        m.pinInChatMessage = Types_1.WAProto.Message.PinInChatMessage.fromObject(message.pinMessage.pinInChatMessage);
    }
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    !!(options === null || options === void 0 ? void 0 : options.ephemeralExpiration) &&
        ...
        message[key].contextInfo = Object.assign(Object.assign({}, (message[key].contextInfo || {})), { expiration: options.ephemeralExpiration || Defaults_1.WA_DEFAULT_EPHEMERAL });
    }
...
const generateWAMessage = (jid, content, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, exports.generateWAMessageFromContent)(jid, yield (0, exports.generateWAMessageContent)(content, options), options);
});
    ...
    try {
        ...
        if (ctx) {
            if (axios_1.default.isAxiosError(error)) {
                ...
                if (REUPLOAD_REQUIRED_STATUS.includes((_d = error.response) === null || _d === void 0 ? void 0 : _d.status)) {
