...
const extractImageThumb = (bufferOrFilePath, width = 32) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
...
const generateProfilePicture = (mediaUpload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lib = yield getImageProcessingLibrary();
    let img;
    if ('sharp' in lib && typeof ((_c = lib.sharp) === null || _c === void 0 ? void 0 : _c.default) === 'function') {
    ...
    else if ('jimp' in lib && typeof ((_d = lib.jimp) === null || _d === void 0 ? void 0 : _d.read) === 'function') {
...
const toBuffer = (stream) => { var _a, stream_2, stream_2_1; return __awaiter(void 0, void 0, void 0, function* () {
    var _b, e_1, _c, _d;
    const chunks = [];
    try {
...
const getHttpStream = (url, options = {}) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.default.get(typeof url === 'string' ? url : url.toString(), Object.assign(Object.assign({}, options), { responseType: 'stream' }));
    return response.data;
});
exports.getHttpStream = getHttpStream;
const encryptedStream = (media, mediaType, { logger, saveOriginalFileIfRequired, opts } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    var _e, e_2, _f, _g;
    ...
    try {
        try {
            for (var _h = true, stream_3 = __asyncValues(stream), stream_3_1; stream_3_1 = yield stream_3.next(), _e = stream_3_1.done, !_e; _h = true) {
                _g = stream_3_1.value;
                _h = false;
                const data = _g;
            ...
            try {
                if (!_h && !_e && (_f = stream_3.return)) yield _f.call(stream_3);
            }
 ...
 * */
const downloadEncryptedContent = (downloadUrl, { cipherKey, iv }, { startByte, endByte, options } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    let bytesFetched = 0;
    let startChunk = 0;
...
const getWAUploadToServer = ({ customUploadHosts, fetchAgent, logger, options }, refreshMediaConn) => {
    return (stream, { mediaType, fileEncSha256B64, timeoutMs }) => { var _a, stream_4, stream_4_1; return __awaiter(void 0, void 0, void 0, function* () {
        var _b, e_3, _c, _d;
        var _e, _f;
        ...
        const chunks = [];
        try {
            for (_a = true, stream_4 = __asyncValues(stream); stream_4_1 = yield stream_4.next(), _b = stream_4_1.done, !_b; _a = true) {
                _d = stream_4_1.value;
                _a = false;
                const chunk = _d;
                chunks.push(chunk);
            ...
            try {
                if (!_a && !_b && (_c = stream_4.return)) yield _c.call(stream_4);
            }
        ...
        for (const { hostname, maxContentLengthBytes } of hosts) {
            ...
            try {
                ...
                const body = yield axios.post(url, reqBody, Object.assign(Object.assign({}, options), { 
                    // @ts-ignore
                    headers: Object.assign(Object.assign({}, options.headers || {}), { 'Content-Type': 'application/octet-stream', 'Origin': Defaults_1.DEFAULT_ORIGIN }), httpsAgent: fetchAgent, timeout: timeoutMs, responseType: 'json', maxBodyLength: Infinity, maxContentLength: Infinity }));
                result = body.data;
                ...
                if (axios.isAxiosError(error)) {
                    result = (_e = error.response) === null || _e === void 0 ? void 0 : _e.data;
                }
                const isLast = hostname === ((_f = hosts[uploadInfo.hosts.length - 1]) === null || _f === void 0 ? void 0 : _f.hostname);
